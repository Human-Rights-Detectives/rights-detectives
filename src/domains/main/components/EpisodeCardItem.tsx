...
const EpisodeCardItem = ({ episodeNumber, title, className = "" }: EpisodeCardItemProps) => {
  return (
    <div className={`w-80 h-20 bg-[#FFE9BC] rounded-[59px] flex flex-col justify-center px-6 py-3 ${className}`}>
