...
const MissionCompleteStep: React.FC<MissionCompleteStepProps> = ({
  ...
  return (
    <div className="relative w-[340px] h-[550px]">
      ...
      {/* 메인 컨텐츠 영역 */}
      <div className="absolute top-64 left-[52%] -translate-x-1/2 w-[230px] h-[127px] z-10">
        {/* 설명 텍스트 */}
        <div className="text-[#4B3118] text-center text-[18px] font-regular font-omyu-pretty leading-[26px] mb-[12px] whitespace-pre-line">
